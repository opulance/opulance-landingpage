    ...
    <>
      ...
      <button
        ...
        className={`fixed z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg ${
          isOpen ? 'bottom-[370px] right-6 bg-gray-700' : 'bottom-6 right-6 bg-gradient-to-r from-emerald-500 to-green-400'
        } transition-all hover:shadow-[0_0_15px_rgba(52,211,153,0.6)] focus:outline-none`}
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="bg-gray-800 p-4 flex items-center">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-emerald-500 to-green-400 flex items-center justify-center mr-3">
            ...
            <form onSubmit={handleSubmit} className="p-4 border-t border-gray-800 bg-gray-900">
              <div className="flex items-center">
                <input
                  ...
                  className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
                <button
                  type="submit"
                  className="ml-2 w-10 h-10 rounded-full bg-gradient-to-r from-emerald-500 to-green-400 flex items-center justify-center"
                  disabled={!input.trim()}
                >
